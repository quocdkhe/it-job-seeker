...
@Controller
public class SeekerFeedbackController {
    ...
    public SeekerFeedbackController(FileService fileService, UserService userService,
            FeedbackService feedbackService,
            SupportRequestService supportRequestService, TopicService topicsService) {
    ...
    public String feedback() {
        return "seeker/feedback-seeker";
    }

    @GetMapping("/feedback-comment")
    public String feedbackComment(Model model, HttpServletRequest request) {
        Feedback feedback = new Feedback();
        List<Topic> topics = topicService.getAllList();

        model.addAttribute("topics", topics);
        model.addAttribute("feedback", feedback);
        return "seeker/feedback-seeker-comment";
    }

    @GetMapping("/feedback-support")
    public String feedbackSupport(Model model, HttpServletRequest request) {
        ...
        return "seeker/feedback-seeker-support";
    }

    @PostMapping("/feedback/submit")
    public String feedbackSeeker(@ModelAttribute("feedback") Feedback feedback,
        ...
        return "redirect:/feedback?comment-support-success";
    }

    @PostMapping("/support/submit-seeker")
    public String supportSeeker(
        ...
        return "redirect:/feedback?feedback-support-success";
    }
